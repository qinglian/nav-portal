...
import { X, Plus, Trash2, Lock, Settings, Power } from 'lucide-react'
import {
  getSafeBoxSites,
  addSafeBoxSite,
  removeSafeBoxSite,
        ...
        <div className={styles.content}>
          {sites.length === 0 && !showAdd && (
            <div className={styles.empty}>
              ...
              <p className={styles.emptyHint}>点击下方按钮添加隐藏网站</p>
            </div>
          )}
            ...
            <div className={styles.sitesGrid}>
              {sites.map(site => (
                <div key={site.id} className={styles.siteCard} onClick={() => handleOpen(site.url)}>
                  <div className={styles.siteIcon}>{site.name.charAt(0)}</div>
          ...
          {showAdd && (
            <div className={styles.addForm}>
              ...
              <div className={styles.formActions}>
                ...
                <button className={styles.confirmBtn} onClick={handleAdd}>添加</button>
              </div>
            </div>
          )}
        </div>
